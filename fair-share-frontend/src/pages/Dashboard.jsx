...
import { FaUsers, FaPlus, FaSignOutAlt, FaUserCircle, FaSearch } from "react-icons/fa";
...
export default function Dashboard() {
  ...
  const token = localStorage.getItem("token"); // always get token once
  ...
  useEffect(() => {
    ...
    if (!token) {
      navigate("/"); // force redirect if token missing
    }
